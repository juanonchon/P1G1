...
function JoinTwoString(){
    var cadenaA = prompt("Ingrese una Cadena", "Hola Mundo")
    var cadenaB = parseInt(prompt("Ingrese Posicion", 3))
...
function MyNamenInASCII(){
    var var_A = String.fromCharCode(65);
    var var_D = String.fromCharCode(68);
    var var_R = String.fromCharCode(82);
    var var_I = String.fromCharCode(73);
    var var_A = String.fromCharCode(65);
    var var_N = String.fromCharCode(78);
    var var_32 = String.fromCharCode(32);
    var var_D = String.fromCharCode(68);
    var var_O = String.fromCharCode(79);
    var var_U = String.fromCharCode(85);
    var var_G = String.fromCharCode(71);
    var var_L = String.fromCharCode(76);
    var var_A = String.fromCharCode(65);
    var var_S = String.fromCharCode(83);
    var var_32 = String.fromCharCode(32);
    var var_F = String.fromCharCode(70);
    ...
    var var_D = String.fromCharCode(68);
    var var_E = String.fromCharCode(69);
    var var_Z = String.fromCharCode(90);
    var var_32 = String.fromCharCode(32);
    var var_M = String.fromCharCode(77);
    var var_A = String.fromCharCode(65);
    var var_T = String.fromCharCode(84);
    var var_O = String.fromCharCode(79);
    var var_S = String.fromCharCode(83);
    alert(var_A + var_D + var_R + var_I + var_A +var_N + var_32 + var_D + var_O + var_U + var_G + var_L + var_A + var_S + var_32 + var_F + var_E + var_R + var_N + var_A + var_N + var_D + var_E + var_Z + var_32 + var_M + var_A + var_T + var_O + var_S  )
    inicio = 97
    fin = 122
    while (fin >= inicio){
